        ...
        public HocSinh LoginHocSinh(string userName, string password)
        {
                ...
                new SqlConnection(this.ConnectionString))
            {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        hocSinhDto.HocSinhId = (long)reader["HocSinhId"];
                    }
                    if (reader["TenHocSinh"] != DBNull.Value)
                    {
                        hocSinhDto.TenHocSinh = (string)reader["TenHocSinh"];
                    }
                    if (reader["NgaySinh"] != DBNull.Value)
                    {
                        hocSinhDto.NgaySinh = (DateTime)reader["NgaySinh"];
                    }
                    if (reader["SoDienThoai"] != DBNull.Value)
                    {
                        hocSinhDto.SoDienThoai = (string)reader["SoDienThoai"];
                    }
                    if (reader["DiaChi"] != DBNull.Value)
                    {
                        hocSinhDto.DiaChi = (string)reader["DiaChi"];
                    }
                    if (reader["Email"] != DBNull.Value)
                    {
                        hocSinhDto.Email = (string)reader["Email"];
                    }
                    if (reader["MatKhau"] != DBNull.Value)
                    {
                        hocSinhDto.MatKhau = (string)reader["MatKhau"];
                    }
                    if (reader["TenDangNhap"] != DBNull.Value)
                    {
                        hocSinhDto.TenDangNhap = (string)reader["TenDangNhap"];
                    }
                    if (reader["Avatar"] != DBNull.Value)
                    {
                        hocSinhDto.Avatar = (string)reader["Avatar"];
                    }
                    if (reader["UserType"] != DBNull.Value)
                    {
                        hocSinhDto.UserType = (long)reader["UserType"];
                    }

                    if(hocSinhDto.HocSinhId != 0)
                    {
                        queryResult = hocSinhDto;
                    }
                }
                //Đóng kết nối
                reader.Close();
